...
if (isset($_GET['delete_id'])) {
    $id_produk = intval($_GET['delete_id']);
    $query = "DELETE FROM produk WHERE id_produk = $id_produk";
    if (mysqli_query($koneksi, $query)) {
        echo "<script>alert('Data berhasil dihapus!'); window.location='../admin/data_produk.php';</script>";
    } else {
            ...
            <div class="container">
                <div class="d-flex justify-content-between align-items-center flex-wrap mb-3 control-bar">
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a class="btn btn-tambah" href="../admin/tambah_produk.php">
                    ...
                    <table id="dataTable" class="table table-bordered table-hover">
                        ...
                        <tbody>
                            ...
                            $data = mysqli_query($koneksi, 
                                "SELECT produk.*, usaha.nama_usaha 
                                FROM produk 
                                INNER JOIN usaha ON produk.id_usaha = usaha.id_usaha");
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($d['nomor_sertifikat'])): ?>
                                        <a href="https://bpjph.halal.go.id/search/sertifikat?nama_produk=&nama_pelaku_usaha=&no_sertifikat=<?= $d['nomor_sertifikat'] ?>&page=1" target="_blank">
                                            <?= $d['nomor_sertifikat'] ?>
                                        </a>
                                    <?php else: ?>
                                ...
                                <td class="text-center">
                                    <div class="btn-group gap-1">
                                        <a href="../admin/detail_produk.php?id=<?= $d['id_produk'] ?>" class="btn btn-info btn-xs" title="Detail">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                        <a href="../admin/edit_produk.php?id=<?= $d['id_produk'] ?>" class="btn btn-warning btn-xs" title="Edit">
                                            <i class="fa fa-edit"></i>
                                        </a>
                                        <a href="../admin/data_produk.php?delete_id=<?= $d['id_produk'] ?>" class="btn btn-danger btn-xs" title="Hapus" onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')">
